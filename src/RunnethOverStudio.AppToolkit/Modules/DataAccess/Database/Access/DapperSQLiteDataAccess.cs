...
public class DapperSQLiteDataAccess : ISQLDataAccess
{
    ...
    public async Task<uint?> CreateAsync<T>(T entity, CancellationToken cancellationToken = default) where T : IDataEntity
    {
        try
        {
            ...
            // Filter out properties that should not be included in INSERT:
            // 1. Id - auto-generated by AUTOINCREMENT
            // 2. CreatedAt - auto-generated by DEFAULT CURRENT_TIMESTAMP
            // 3. Navigation properties - complex types (not primitives, strings, or byte arrays)
